...
def cloud_motion(seg_frame1: np.ndarray, seg_frame2: np.ndarray, percent_cover: float, 
                 image_filename: str, now: datetime, csv_array: list, motion_mask: cv2.Mat, debug=False):
    ...
    csv_array.append([now, image_name, percent_cover, avg_magnitude, direction])
    return csv_array

def main():
    seg1 = cv2.imread('set3/2025-03-23_18-33-45.jpg', cv2.IMREAD_GRAYSCALE)
    image_filename = 'set3/2025-03-23_18-34-15.jpg'
    percent = 10
